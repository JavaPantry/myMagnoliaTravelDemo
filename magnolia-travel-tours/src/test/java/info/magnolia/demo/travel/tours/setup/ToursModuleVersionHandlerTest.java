...
//TODO AVP import info.magnolia.ui.framework.action.OpenExportDialogActionDefinition; replace with following
import info.magnolia.ui.framework.action.OpenCreateDialogActionDefinition;
//TODO AVP import info.magnolia.virtualuri.mapping.RegexpVirtualUriMapping;
...
public class ToursModuleVersionHandlerTest extends ModuleVersionHandlerTestCase {
    ...
    public void updateFrom113ReconfiguresExportAction() throws Exception {
        ...
        //TODO AVP assertThat(exportActionNode, hasProperty("class", OpenExportDialogActionDefinition.class.getName()));
